...
/**
 * The mod_grouppeerreview group peer review report viewed event.
 *
...
/**
 * The mod_grouppeerreview group peer review report viewed event class.
 *
 * @package    mod_grouppeerreview
 * @author     John Illsley <j.s.illsley@bath.ac.uk>
 * @copyright  2018 University of Bath
...
class report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportviewed', 'mod_grouppeerreview');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed the report for the group peer review activity with course
